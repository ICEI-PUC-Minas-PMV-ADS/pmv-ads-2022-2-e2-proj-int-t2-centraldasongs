...
CREATE TABLE [ong_bank_information] (
    ...
    CONSTRAINT [FK_ong_bank_information_banks_BankId] FOREIGN KEY ([BankId]) REFERENCES [banks] ([Code]) ON DELETE CASCADE,
...
CREATE TABLE [adress] (
    ...
    CONSTRAINT [FK_adress_user_ong_UserOngId] FOREIGN KEY ([UserOngId]) REFERENCES [user_ong] ([Cnpj]) ON DELETE NO ACTION,
    CONSTRAINT [FK_adress_user_voluntario_UserVoluntarioId] FOREIGN KEY ([UserVoluntarioId]) REFERENCES [user_voluntario] ([Cpf]) ON DELETE NO ACTION
);
GO
