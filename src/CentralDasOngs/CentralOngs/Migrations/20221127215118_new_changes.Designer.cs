...
namespace CentralOngs.Migrations
{
    ...
    [Migration("20221127215118_new_changes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CentralOngs.Models.VacancyModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("UserVoluntarioAbout")
                        .HasColumnType("text");

                    b.Property<int>("UserVoluntarioId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CentralOngs.Models.VacancyModel", b =>
                {
                    b.HasOne("CentralOngs.Models.JobModel", "Job")
                        .WithMany("Vacancy")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CentralOngs.Models.UserVoluntarioModel", "UserVoluntario")
                        .WithMany("Vacancy")
